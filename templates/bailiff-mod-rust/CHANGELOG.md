...
All notable changes to `bailiff-mod-rust` are documented here. Managed by
...
- Initial Rust language overlay (spec 011):
  ...
  - `run_after: [bailiff-mod-base]` edge; threads `project_name` and `hook_manager`;
...
## bailiff-mod-rust-v0.1.0 - 2026-07-15
#### Features
- (**011**) implement bailiff-mod-rust - (a6a6d2a) - Sjors Robroek
#### Bug Fixes
