...
All notable changes to `bailiff-mod-ts` are documented here. Managed by
...
#### Bug Fixes
- (**bailiff-mod-ts**) wrap pre-commit fragment in top-level repos: mapping - (a991e2e) - Sjors Robroek

- - -

## bailiff-mod-ts-v0.1.2 - 2026-07-16
#### Bug Fixes
